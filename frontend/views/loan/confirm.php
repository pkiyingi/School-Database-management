...
<?php $form = ActiveForm::begin(['action' => Url::to(['loan/apply'])]); ?>
    ...
    <div class="col-lg-12">
        <div class="letter">
            <div class="heading text-center">
                ...
                <h3 style='color:#003'>LOAN APPLICATION NO:LOAN/1703001</h3>
                ...
                <div class="col-lg-8">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <?=
                                $_POST['repayment_period']
                                ?> months

                                <?= $form->field($model, 'repayment_period')->hiddenInput(['value' => $_POST['repayment_period']])->label(false);
                                ?>
                            </td>
                        </tr>
                        <tr>
